import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, defineComponent, provide, h, ref, Suspense, Fragment, resolveComponent, computed, createVNode, resolveDynamicComponent, mergeProps, useSSRContext, createElementBlock, openBlock, createElementVNode, withCtx, createTextVNode, toDisplayString, unref, onErrorCaptured, onServerPrefetch, createApp } from "vue";
import { $fetch } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/gda/Documents/test/nexusbuild/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/gda/Documents/test/nexusbuild/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "/home/gda/Documents/test/nexusbuild/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, RouterView } from "vue-router";
import { toRouteMatcher, createRouter } from "/home/gda/Documents/test/nexusbuild/node_modules/radix3/dist/index.mjs";
import { defu } from "/home/gda/Documents/test/nexusbuild/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash } from "/home/gda/Documents/test/nexusbuild/node_modules/ufo/dist/index.mjs";
import { ssrRenderVNode, ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderClass, ssrRenderAttr, ssrRenderSuspense } from "vue/server-renderer";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    name: "faq",
    path: "/faq",
    component: () => import("./_nuxt/faq-CamKddQC.js")
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import("./_nuxt/blog-BlQPEH1a.js")
  },
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-CXNVGd6w.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DYhfNpHq.js")
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-B5xjBDcs.js")
  },
  {
    name: "pricing",
    path: "/pricing",
    component: () => import("./_nuxt/pricing-BB8CW7X2.js")
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import("./_nuxt/profile-DT3WcqaR.js")
  },
  {
    name: "contacts",
    path: "/contacts",
    component: () => import("./_nuxt/contacts-8AVF737w.js")
  },
  {
    name: "register",
    path: "/register",
    component: () => import("./_nuxt/register-Co1zYVvg.js")
  },
  {
    name: "services",
    path: "/services",
    component: () => import("./_nuxt/services-C5iCcGy0.js")
  },
  {
    name: "portfolio",
    path: "/portfolio",
    component: () => import("./_nuxt/portfolio-B2XEkvOC.js")
  }
];
...
const LazySvgoUser = defineAsyncComponent(() => import("./_nuxt/user-vl42SSO4.js").then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CbggMTdg.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Dkau74HC.js"));
