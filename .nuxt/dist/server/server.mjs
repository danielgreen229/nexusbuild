...
import { sanitizeStatusCode, createError as createError$1 } from "/Users/danielgreen/Documents/sprintweb/nexusbuild/node_modules/h3/dist/index.mjs";
...
import { ssrRenderVNode, ssrRenderAttrs, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderSuspense } from "vue/server-renderer";
if (!globalThis.$fetch) {
...
const _routes = [
  ...
  },
  {
    name: "templates",
    path: "/templates",
    component: () => import("./_nuxt/templates-_oxWeK3x.js")
  },
  {
    name: "buy-template-id",
    path: "/buy-template/:id()",
    component: () => import("./_nuxt/_id_-BISEckwS.js")
  },
  {
    name: "buy-template",
    path: "/buy-template",
...
const LazySvgoOpenNext = defineAsyncComponent(() => import("./_nuxt/open-next-BTngSjB-.js").then((r) => r["default"] || r.default || r));
const LazySvgoUser = defineAsyncComponent(() => import("./_nuxt/user-CYYBwZaE.js").then((r) => r["default"] || r.default || r));
