import { ref, mergeProps, unref, isRef, computed, withCtx, createTextVNode, useSSRContext } from 'file:///Users/danielgreen/Documents/sprintweb/nexusbuild/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderAttr } from 'file:///Users/danielgreen/Documents/sprintweb/nexusbuild/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main$4 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "portfolio-filters" }, _attrs))} data-v-79defb6a><div class="portfolio-filters__container container" data-v-79defb6a><div class="portfolio-filters__wrapper" data-v-79defb6a><!--[-->`);
      ssrRenderList(unref(filters), (filter) => {
        _push(`<button class="${ssrRenderClass(["portfolio-filters__button", { "portfolio-filters__button--active": __props.activeFilter === filter.id }])}" data-v-79defb6a>${ssrInterpolate(filter.name)}</button>`);
      });
...
const PortfolioFilters = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-79defb6a"]]);
const _sfc_main$3 = {
  __name: "TemplateCard",
  __ssrInlineRender: true,
  props: {
...
//# sourceMappingURL=portfolio-BrCiorGJ.mjs.map
