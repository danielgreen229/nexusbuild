...
const useTemplateStore = defineStore("template", {
  ...
  actions: {
    ...
    async listTemplatesInfinite({ limit = 20, lastCreatedAt = null, lastId = null, order = "desc", filters = {}, lastHaveHtml = void 0, lastPopular = void 0 } = {}) {
      const params = {
        limit,
        lastCreatedAt,
        lastId,
        order,
        lastHaveHtml: typeof lastHaveHtml !== "undefined" ? lastHaveHtml ? "1" : "0" : void 0,
        lastPopular: typeof lastPopular !== "undefined" ? lastPopular ? "1" : "0" : void 0,
        type: filters.type,
        popular: typeof filters.popular !== "undefined" ? filters.popular ? "1" : "0" : void 0,
        min_price: filters.min_price,
        max_price: filters.max_price,
...
//# sourceMappingURL=template-B72Yob-U.mjs.map
