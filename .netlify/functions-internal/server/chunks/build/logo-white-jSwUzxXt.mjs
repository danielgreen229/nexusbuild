...
const _hoisted_1 = {
  ...
  fill: "none",
  class: "i1176203523__nuxt-icon i1176203523__app-header__logo-svg",
  viewBox: "0 0 156 34"
};
...
const logoWhite = { render() {
  return h(NuxtIcon, { icon: { render }, name: "logo-white" });
} };

export { logoWhite as default, render };
//# sourceMappingURL=logo-white-jSwUzxXt.mjs.map
