...
const _routes = [
  {
    name: "faq",
    path: "/faq",
    component: () => import('./faq-BMlcGWbs.mjs')
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import('./blog-DxquUNuH.mjs')
  },
  {
    name: "about",
    path: "/about",
  ...
  },
  {
    name: "admin",
    path: "/admin",
    component: () => import('./admin-BOPqejvP.mjs')
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-DrdvKIji.mjs')
  },
  {
    name: "submit",
    path: "/submit",
  ...
  },
  {
    name: "contacts",
    path: "/contacts",
    component: () => import('./contacts-B5MeWRMq.mjs')
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-DlFFX-n3.mjs')
  },
  {
    name: "services",
    path: "/services",
...
const LazySvgoBigEmail = defineAsyncComponent(() => import('./big-email-dFX6Kh5b.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoIconClick = defineAsyncComponent(() => import('./icon-click-CZvvVRyr.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoLandingCone = defineAsyncComponent(() => import('./Cone-S8GsaI1p.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoLandingBg = defineAsyncComponent(() => import('./bg-CfI5hjDV.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoLandingBlockBgMobile = defineAsyncComponent(() => import('./block-bg-mobile-BIVCgtr-.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoLandingBlockBg = defineAsyncComponent(() => import('./block-bg-CptgMeT7.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Do_ozxqR.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DGmE-xbP.mjs'));
