...
import { _ as _export_sfc, c as useUserStore, n as navigateTo } from './server.mjs';
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "portfolio-hero" }, _attrs))} data-v-9aae542a><div class="portfolio-hero__container container" data-v-9aae542a><div class="portfolio-hero__content" data-v-9aae542a><h1 class="portfolio-hero__title" data-v-9aae542a>${ssrInterpolate(title)}</h1><p class="portfolio-hero__subtitle" data-v-9aae542a>${ssrInterpolate(subtitle)}</p><form class="portfolio-hero__search" aria-label="\u041F\u043E\u0438\u0441\u043A \u0448\u0430\u0431\u043B\u043E\u043D\u043E\u0432" data-v-9aae542a><div class="search-wrap" data-v-9aae542a><input${ssrRenderAttr("value", search.value)} type="search" placeholder="\u041D\u0430\u0439\u0442\u0438 \u0448\u0430\u0431\u043B\u043E\u043D..." class="portfolio-hero__input" aria-label="\u041F\u043E\u0438\u0441\u043A \u0448\u0430\u0431\u043B\u043E\u043D\u043E\u0432" data-v-9aae542a><button type="submit" class="btn-search"${ssrIncludeBooleanAttr(unref(templateStore).loading) ? " disabled" : ""} data-v-9aae542a>`);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        role: "group",
        tabindex: "0"
      }, _attrs))} data-v-0acd0c35><div class="template-card__image" data-v-0acd0c35><img${ssrRenderAttr("src", __props.template.preview)}${ssrRenderAttr("alt", __props.template.title)} loading="lazy" draggable="false" data-v-0acd0c35><div class="template-card__badges" data-v-0acd0c35>`);
      if (haveHtml.value) {
        _push(`<div class="template-card__badge template-card__badge--custom" data-v-0acd0c35>\u0417\u0430\u043A\u0430\u0437\u043D\u043E\u0439</div>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.template.popular) {
        _push(`<div class="template-card__badge template-card__badge--popular" data-v-0acd0c35>\u041F\u043E\u043F\u0443\u043B\u044F\u0440\u043D\u044B\u0439</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><button class="template-card__view-button" type="button" aria-label="\u041F\u0440\u043E\u0441\u043C\u043E\u0442\u0440\u0435\u0442\u044C \u0448\u0430\u0431\u043B\u043E\u043D" data-v-0acd0c35> \u041F\u0440\u043E\u0441\u043C\u043E\u0442\u0440\u0435\u0442\u044C `);
      _push(ssrRenderComponent(unref(OpenNext), { class: "open-next__svg" }, null, _parent));
      _push(`</button></div><div class="template-card__content" data-v-0acd0c35><div class="template-card__header" data-v-0acd0c35><h3 class="template-card__title" data-v-0acd0c35>${ssrInterpolate(__props.template.title)}</h3><div class="template-card__price" aria-live="polite" data-v-0acd0c35>`);
      if (computedDiscountAmount.value > 0) {
        _push(`<div style="${ssrRenderStyle({ "text-align": "right" })}" data-v-0acd0c35><div style="${ssrRenderStyle({ "font-size": "0.9rem", "color": "#64748b", "text-decoration": "line-through" })}" data-v-0acd0c35>${ssrInterpolate(fmt(price.value))} \u20BD</div><div style="${ssrRenderStyle({ "font-size": "1.2rem", "font-weight": "700", "color": "#f97315" })}" data-v-0acd0c35>${ssrInterpolate(fmt(finalPrice.value))} \u20BD</div><div style="${ssrRenderStyle({ "font-size": "0.8rem", "color": "#065f46" })}" data-v-0acd0c35>\u0421\u043A\u0438\u0434\u043A\u0430: `);
        if (discountPercent.value > 0) {
          _push(`<span data-v-0acd0c35>${ssrInterpolate(discountPercent.value)}%</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
      ...
      _push(`</div></div><p class="template-card__description" data-v-0acd0c35>${ssrInterpolate(__props.template.description)}</p><div class="template-card__features" data-v-0acd0c35><!--[-->`);
      ssrRenderList(__props.template.features, (feature, idx) => {
        _push(`<span class="template-card__feature" data-v-0acd0c35>${ssrInterpolate(feature)}</span>`);
      });
      _push(`<!--]--></div>`);
...
const TemplateCard = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-0acd0c35"]]);
const PER_PAGE = 12;
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "portfolio-page" }, _attrs))} data-v-61bc1864>`);
...
const templates = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-61bc1864"]]);

export { templates as default };
//# sourceMappingURL=templates-Ct_ujbsJ.mjs.map
