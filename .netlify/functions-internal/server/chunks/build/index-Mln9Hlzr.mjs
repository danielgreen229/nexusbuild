...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "profile-orders" }, _attrs))} data-v-f8dbe4b4><h2 class="profile-orders__title" data-v-f8dbe4b4>\u041C\u043E\u0438 \u0437\u0430\u043A\u0430\u0437\u044B</h2>`);
      if (loadingInitial.value) {
        _push(`<div class="profile-orders__loading" data-v-f8dbe4b4>\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430 \u0437\u0430\u043A\u0430\u0437\u043E\u0432...</div>`);
      } else if (error.value) {
        _push(`<div class="profile-orders__loading" data-v-f8dbe4b4> \u041E\u0448\u0438\u0431\u043A\u0430: ${ssrInterpolate(error.value)} <div style="${ssrRenderStyle({ "margin-top": "12px" })}" data-v-f8dbe4b4><button class="primary__button" data-v-f8dbe4b4>\u041F\u043E\u0432\u0442\u043E\u0440\u0438\u0442\u044C</button></div></div>`);
      } else if (orders.value.length === 0) {
        _push(`<div class="profile-orders__empty" data-v-f8dbe4b4> \u0423 \u0432\u0430\u0441 \u043F\u043E\u043A\u0430 \u043D\u0435\u0442 \u0437\u0430\u043A\u0430\u0437\u043E\u0432 <button class="primary__button" data-v-f8dbe4b4> \u041A\u0443\u043F\u0438\u0442\u044C \u0441\u0430\u0439\u0442 `);
        _push(ssrRenderComponent(unref(NextCircle), { class: "next-cirlce__svg" }, null, _parent));
        _push(`</button></div>`);
      } else {
        _push(`<div class="profile-orders__table" role="table" aria-label="\u0421\u043F\u0438\u0441\u043E\u043A \u0437\u0430\u043A\u0430\u0437\u043E\u0432" data-v-f8dbe4b4><div class="profile-orders__row profile-orders__row--header" role="row" data-v-f8dbe4b4><div class="profile-orders__cell" data-v-f8dbe4b4>\u0414\u0430\u0442\u0430</div><div class="profile-orders__cell" data-v-f8dbe4b4>\u0428\u0430\u0431\u043B\u043E\u043D</div><div class="profile-orders__cell" data-v-f8dbe4b4>\u0421\u0442\u0430\u0442\u0443\u0441 \u0440\u0430\u0437\u0440\u0430\u0431\u043E\u0442\u043A\u0438</div><div class="profile-orders__cell" data-v-f8dbe4b4>\u0421\u0442\u0430\u0442\u0443\u0441</div><div class="profile-orders__cell" data-v-f8dbe4b4>\u0421\u0443\u043C\u043C\u0430</div><div class="profile-orders__cell" data-v-f8dbe4b4>\u0414\u0435\u0439\u0441\u0442\u0432\u0438\u044F</div></div><!--[-->`);
        ssrRenderList(orders.value, (order, idx) => {
          var _a2, _b2;
          var _a, _b, _c, _d, _e, _f;
          _push(`<!--[-->`);
          if (order) {
            _push(`<div class="profile-orders__row profile-orders__row--data" role="row"${ssrRenderAttr("aria-label", `\u0417\u0430\u043A\u0430\u0437 ${order.id}`)} data-v-f8dbe4b4><div class="profile-orders__cell profile-orders__cell--date"${ssrRenderAttr("title", order.date)} data-v-f8dbe4b4>${ssrInterpolate(order.date)}</div><div class="profile-orders__cell profile-orders__cell--template" data-v-f8dbe4b4><div class="profile-orders__template" data-v-f8dbe4b4>`);
            if ((_b = (_a = order.raw) == null ? void 0 : _a.template) == null ? void 0 : _b.preview) {
              _push(`<img${ssrRenderAttr("src", order.raw.template.preview)} class="profile-orders__thumb"${ssrRenderAttr("alt", order.template || "preview")} data-v-f8dbe4b4>`);
            } else {
              _push(`<div class="profile-orders__thumb profile-orders__thumb--placeholder" data-v-f8dbe4b4></div>`);
            }
            _push(`<div class="profile-orders__template-info" data-v-f8dbe4b4><div class="profile-orders__template-title"${ssrRenderAttr("title", (_a2 = (_d = (_c = order.raw) == null ? void 0 : _c.domain) == null ? void 0 : _d.fqdn) != null ? _a2 : order.template)} data-v-f8dbe4b4>${ssrInterpolate((_b2 = (_f = (_e = order.raw) == null ? void 0 : _e.domain) == null ? void 0 : _f.fqdn) != null ? _b2 : order.template)}</div>`);
            _push(ssrRenderComponent(unref(openIcon), { class: "open__svg" }, null, _parent));
            _push(`</div></div></div><div class="profile-orders__cell profile-orders__cell--status"${ssrRenderAttr("title", getDeployStatusTitle(order.raw.deploy_status))} data-v-f8dbe4b4><span class="${ssrRenderClass(["profile-orders__status", `profile-orders__status--${order.statusCode}`])}" data-v-f8dbe4b4>${ssrInterpolate(getDeployStatusTitle(order.raw.deploy_status))}</span></div><div class="profile-orders__cell profile-orders__cell--status"${ssrRenderAttr("title", getStatusTitle(order.status))} data-v-f8dbe4b4><span class="${ssrRenderClass(["profile-orders__status", `profile-orders__status--${order.statusCode}`])}" data-v-f8dbe4b4>${ssrInterpolate(getStatusTitle(order.status))}</span></div><div class="profile-orders__cell profile-orders__cell--price"${ssrRenderAttr("title", formatPriceForDisplay(order))} data-v-f8dbe4b4>${ssrInterpolate(formatPriceForDisplay(order))}</div><div class="profile-orders__cell profile-orders__cell--actions" data-v-f8dbe4b4>`);
            if (!(paymentLoading.value === order.id || order.status === "completed" || order.status === "in_progress")) {
              _push(`<button class="profile-orders__pay" data-v-f8dbe4b4>`);
              if (paymentLoading.value === order.id) {
                _push(`<span data-v-f8dbe4b4>\u041F\u0435\u0440\u0435\u0445\u043E\u0434 \u043A \u043E\u043F\u043B\u0430\u0442\u0435...</span>`);
              } else {
                _push(`<span data-v-f8dbe4b4>\u041E\u043F\u043B\u0430\u0442\u0438\u0442\u044C</span>`);
              }
              _push(`</button>`);
            } else {
              _push(`<!---->`);
            }
            _push(`<button class="profile-orders__action" data-v-f8dbe4b4>\u041F\u043E\u0434\u0440\u043E\u0431\u043D\u0435\u0435</button></div></div>`);
          } else {
            _push(`<!---->`);
          }
          if (order && paymentErrors.value[order.id]) {
            _push(`<div class="profile-orders__row profile-orders__row--error" style="${ssrRenderStyle({ "background": "#fff7f7" })}" data-v-f8dbe4b4><div class="profile-orders__cell profile-orders__cell--error" style="${ssrRenderStyle({ "grid-column": "1 / -1", "color": "#b91c1c" })}" data-v-f8dbe4b4> \u041E\u0448\u0438\u0431\u043A\u0430 \u043E\u043F\u043B\u0430\u0442\u044B (${ssrInterpolate(order.id)}): ${ssrInterpolate(paymentErrors.value[order.id])}</div></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<!--]-->`);
        });
        _push(`<!--]--><div class="profile-orders__row profile-orders__row--footer" style="${ssrRenderStyle({ "border-top": "none" })}" data-v-f8dbe4b4><div class="profile-orders__cell" style="${ssrRenderStyle({ "grid-column": "1 / -1", "display": "flex", "justify-content": "center", "padding": "20px" })}" data-v-f8dbe4b4>`);
        if (loadingMore.value) {
          _push(`<div class="profile-orders__loading" data-v-f8dbe4b4>\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430...</div>`);
        } else if (noMore.value) {
          _push(`<div class="profile-orders__loading" data-v-f8dbe4b4>\u0411\u043E\u043B\u044C\u0448\u0435 \u0437\u0430\u043A\u0430\u0437\u043E\u0432 \u043D\u0435\u0442</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div><div style="${ssrRenderStyle({ "height": "1px", "width": "100%" })}" data-v-f8dbe4b4></div></div>`);
      }
      _push(`</div>`);
    };
  }
...
const ProfileOrders = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-f8dbe4b4"]]);
const _sfc_main$1 = {
...
//# sourceMappingURL=index-Mln9Hlzr.mjs.map
