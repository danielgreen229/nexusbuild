...
import { _ as _export_sfc, c as useUserStore, d as useAlertStore, L as LoginModal, A as API } from './server.mjs';
import { defineStore } from 'pinia';
import { u as useOrdersStore } from './order-Bw7cn7lw.mjs';
import { D as DomainFinder } from './domain-finder-C0TQ07P4.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "buy__container" }, _attrs))} data-v-93c0247f><div class="wrapper" data-v-93c0247f><section class="card card__container" data-v-93c0247f><div class="card__left" data-v-93c0247f><h1 class="title" data-v-93c0247f>\u0421\u0430\u0439\u0442 &quot;${ssrInterpolate(template.value.title)}&quot;</h1><h3 class="card__h3" data-v-93c0247f>\u0414\u043E\u043F\u043E\u043B\u043D\u0438\u0442\u0435\u043B\u044C\u043D\u044B\u0435 \u043E\u043F\u0446\u0438\u0438</h3><div class="extras" data-v-93c0247f><label class="addon custom-switch" data-v-93c0247f><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(addons.value.priority.enabled) ? ssrLooseContain(addons.value.priority.enabled, null) : addons.value.priority.enabled) ? " checked" : ""} data-v-93c0247f><span class="switch-track" aria-hidden data-v-93c0247f><span class="switch-thumb" data-v-93c0247f></span></span><span class="label-text" data-v-93c0247f>\u041F\u0440\u0438\u043E\u0440\u0438\u0442\u0435\u0442\u043D\u0430\u044F \u0434\u043E\u0440\u0430\u0431\u043E\u0442\u043A\u0430 \u2014 ${ssrInterpolate(formatCurrency(addons.value.priority.price))}</span></label></div><h3 class="card__h3 domain__h3" data-v-93c0247f>\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0434\u043E\u043C\u0435\u043D</h3><div class="domain__container" data-v-93c0247f><div class="domain-scroll__container" data-v-93c0247f>`);
      _push(ssrRenderComponent(DomainFinder, { onSelectDomain: onDomainSelected }, null, _parent));
      _push(`</div></div></div><div class="card__right" data-v-93c0247f><div class="meta" data-v-93c0247f><span class="price" data-v-93c0247f>${ssrInterpolate(formatCurrency(template.value.price))}</span></div></div></section><aside class="card sidebar" data-v-93c0247f><h2 data-v-93c0247f>\u0412\u0430\u0448 \u0437\u0430\u043A\u0430\u0437</h2><div class="order-lines" data-v-93c0247f><div class="line" data-v-93c0247f><span data-v-93c0247f>\u0411\u0430\u0437\u043E\u0432\u0430\u044F \u0446\u0435\u043D\u0430</span><span data-v-93c0247f>${ssrInterpolate(formatCurrency(basePrice.value))}</span></div>`);
      if (addons.value.priority.enabled) {
        _push(`<div class="line" data-v-93c0247f><span data-v-93c0247f>\u041F\u0440\u0438\u043E\u0440\u0438\u0442\u0435\u0442</span><span data-v-93c0247f>${ssrInterpolate(formatCurrency(addons.value.priority.price))}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      if (addons.value.hosting.enabled) {
        _push(`<div class="line" data-v-93c0247f><span data-v-93c0247f>\u041F\u043E\u0434\u043A\u043B\u044E\u0447\u0435\u043D\u0438\u0435 / \u0445\u043E\u0441\u0442\u0438\u043D\u0433</span><span data-v-93c0247f>${ssrInterpolate(formatCurrency(addons.value.hosting.price))}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      if (selectedDomain.value) {
        _push(`<div class="line" data-v-93c0247f><span data-v-93c0247f>\u0414\u043E\u043C\u0435\u043D (${ssrInterpolate(selectedDomain.value.fqdn)})</span><span data-v-93c0247f>${ssrInterpolate(formatCurrency(domainCost.value))}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<hr data-v-93c0247f><div class="line" data-v-93c0247f><strong data-v-93c0247f>\u041F\u0440\u043E\u043C\u0435\u0436\u0443\u0442\u043E\u0447\u043D\u0430\u044F \u0441\u0443\u043C\u043C\u0430</strong><strong data-v-93c0247f>${ssrInterpolate(formatCurrency(subtotal.value))}</strong></div><div class="line" style="${ssrRenderStyle({ "flex-direction": "column", "align-items": "stretch", "gap": "0.5rem", "padding-top": "0.5rem" })}" data-v-93c0247f><div style="${ssrRenderStyle({ "display": "flex", "gap": "0.5rem", "align-items": "center" })}" data-v-93c0247f><input${ssrRenderAttr("value", promoCodeInput.value)}${ssrIncludeBooleanAttr(unref(codesStore).loading || applyingPromo.value) ? " disabled" : ""} placeholder="\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043F\u0440\u043E\u043C\u043E\u043A\u043E\u0434" class="promocode__input" style="${ssrRenderStyle({ "flex": "1" })}" aria-label="\u041F\u0440\u043E\u043C\u043E\u043A\u043E\u0434" data-v-93c0247f><button class="btn primary"${ssrIncludeBooleanAttr(unref(codesStore).loading || applyingPromo.value || !promoCodeTrimmed.value) ? " disabled" : ""} title="\u041D\u0430\u0436\u043C\u0438\u0442\u0435, \u0447\u0442\u043E\u0431\u044B \u043F\u0440\u043E\u0432\u0435\u0440\u0438\u0442\u044C \u0438 \u043F\u0440\u0438\u043C\u0435\u043D\u0438\u0442\u044C \u043F\u0440\u043E\u043C\u043E\u043A\u043E\u0434" data-v-93c0247f>`);
      if (!applyingPromo.value) {
        _push(`<span data-v-93c0247f>${ssrInterpolate(unref(codesStore).loading ? "\u041E\u0431\u0440\u0430\u0431\u043E\u0442\u043A\u0430\u2026" : "\u041F\u0440\u0438\u043C\u0435\u043D\u0438\u0442\u044C")}</span>`);
      } else {
        _push(`<span data-v-93c0247f>\u041F\u0440\u0438\u043C\u0435\u043D\u044F\u0435\u0442\u0441\u044F\u2026</span>`);
      }
      _push(`</button></div>`);
      if (promoError.value) {
        _push(`<div class="note" style="${ssrRenderStyle({ "color": "#b91c1c", "margin-top": "0.25rem" })}" data-v-93c0247f>${ssrInterpolate(promoError.value)}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (promoAppliedExists.value) {
        _push(`<div class="note" style="${ssrRenderStyle({ "color": "#064e3b", "margin-top": "0.25rem" })}" data-v-93c0247f> \u041F\u0440\u043E\u043C\u043E\u043A\u043E\u0434 \xAB${ssrInterpolate(appliedPromoCode.value)}\xBB \u0443\u0441\u043F\u0435\u0448\u043D\u043E \u043F\u0440\u0438\u043C\u0435\u043D\u0451\u043D \u2014 \u0441\u043A\u0438\u0434\u043A\u0430 ${ssrInterpolate(formatCurrency(appliedPromoDiscount.value))}. </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (promoPreviewExists.value && !promoAppliedExists.value) {
        _push(`<div class="line discount" data-v-93c0247f><span data-v-93c0247f>\u041F\u0440\u043E\u043C\u043E\u043A\u043E\u0434: ${ssrInterpolate(promoPreviewCode.value || promoCodeInput.value)}</span><span data-v-93c0247f>-${ssrInterpolate(formatCurrency(promoPreviewDiscount.value))}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      if (promoAppliedExists.value) {
        _push(`<div class="line discount" data-v-93c0247f><span data-v-93c0247f>\u041F\u0440\u043E\u043C\u043E\u043A\u043E\u0434: ${ssrInterpolate(appliedPromoCode.value)}</span><span data-v-93c0247f>-${ssrInterpolate(formatCurrency(appliedPromoDiscount.value))}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      if (templateDiscountAmount.value > 0) {
        _push(`<div class="line discount" data-v-93c0247f><span data-v-93c0247f>\u0421\u043A\u0438\u0434\u043A\u0430 \u0448\u0430\u0431\u043B\u043E\u043D\u0430 ${ssrInterpolate(discountLabel.value)}</span><span data-v-93c0247f>-${ssrInterpolate(formatCurrency(templateDiscountAmount.value))}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      if (selectedDomain.value) {
        _push(`<div class="line" data-v-93c0247f><span data-v-93c0247f>\u0412\u044B\u0431\u0440\u0430\u043D \u0434\u043E\u043C\u0435\u043D</span><span style="${ssrRenderStyle({ "display": "flex", "gap": "0.5rem", "align-items": "center" })}" data-v-93c0247f><strong data-v-93c0247f>${ssrInterpolate(selectedDomain.value.fqdn)}</strong><button class="btn ghost" title="\u0421\u0431\u0440\u043E\u0441\u0438\u0442\u044C \u0432\u044B\u0431\u043E\u0440 \u0434\u043E\u043C\u0435\u043D\u0430" data-v-93c0247f>\u0421\u0431\u0440\u043E\u0441\u0438\u0442\u044C</button></span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="line total" data-v-93c0247f><strong data-v-93c0247f>\u0418\u0442\u043E\u0433\u043E</strong><strong data-v-93c0247f>${ssrInterpolate(formatCurrency(finalTotal.value))}</strong></div></div><div class="order-actions" data-v-93c0247f>`);
      if (isAuthenticated.value) {
        _push(`<!--[--><label class="input" data-v-93c0247f> \u0424\u0418\u041E: <div class="readonly-field" aria-live="polite" data-v-93c0247f>${ssrInterpolate(userInfo.value.fullname || "\u2014")}</div></label><label class="input" data-v-93c0247f> \u0422\u0435\u043B\u0435\u0444\u043E\u043D: <div class="readonly-field" aria-live="polite" data-v-93c0247f>${ssrInterpolate(userInfo.value.phone || "\u2014")}</div></label><label class="input" data-v-93c0247f> \u041F\u043E\u0447\u0442\u0430: <div class="readonly-field" aria-live="polite" data-v-93c0247f>${ssrInterpolate(userInfo.value.email || "\u2014")}</div></label><!--]-->`);
      } else {
        _push(`<div class="login-row" data-v-93c0247f> \u041D\u0435\u043E\u0431\u0445\u043E\u0434\u0438\u043C\u043E <button class="btn-link" data-v-93c0247f>\u0412\u043E\u0439\u0442\u0438</button> \u0438\u043B\u0438 <button class="btn-link" data-v-93c0247f>\u0417\u0430\u0440\u0435\u0433\u0438\u0441\u0442\u0440\u0438\u0440\u043E\u0432\u0430\u0442\u044C\u0441\u044F</button></div>`);
      }
      _push(`<button class="btn primary"${ssrIncludeBooleanAttr(placing.value || !canPlaceOrder.value) ? " disabled" : ""} data-v-93c0247f>${ssrInterpolate(placing.value ? "\u041E\u0444\u043E\u0440\u043C\u043B\u0435\u043D\u0438\u0435\u2026" : "\u041E\u0444\u043E\u0440\u043C\u0438\u0442\u044C \u0437\u0430\u043A\u0430\u0437")}</button><div class="note" aria-live="polite" data-v-93c0247f><small data-v-93c0247f> \u041D\u0430\u0436\u0438\u043C\u0430\u044F \xAB\u041E\u0444\u043E\u0440\u043C\u0438\u0442\u044C \u0437\u0430\u043A\u0430\u0437\xBB, \u0432\u044B \u0441\u043E\u0433\u043B\u0430\u0448\u0430\u0435\u0442\u0435\u0441\u044C \u0441 <a data-v-93c0247f>\u0443\u0441\u043B\u043E\u0432\u0438\u044F\u043C\u0438 \u043E\u0444\u0435\u0440\u0442\u044B</a> \u0438 <a data-v-93c0247f>\u043F\u043E\u043B\u0438\u0442\u0438\u043A\u043E\u0439 \u043A\u043E\u043D\u0444\u0438\u0434\u0435\u043D\u0446\u0438\u0430\u043B\u044C\u043D\u043E\u0441\u0442\u0438</a>. </small></div></div></aside></div>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-93c0247f"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-UOeqcRjD.mjs.map
