...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "df-root" }, _attrs))} data-v-551b762f><main class="df-container" data-v-551b762f><section class="df-search-card" data-v-551b762f><form class="df-form" data-v-551b762f><div class="df-row" data-v-551b762f><label class="df-label" data-v-551b762f>\u041A\u043B\u044E\u0447\u0435\u0432\u043E\u0435 \u0441\u043B\u043E\u0432\u043E</label><input${ssrRenderAttr("value", keyword.value)} class="df-input" placeholder="\u041D\u0430\u043F\u0440\u0438\u043C\u0435\u0440: mybrand" data-v-551b762f></div><div class="df-row df-row--inline" data-v-551b762f><div class="df-actions" data-v-551b762f><button${ssrIncludeBooleanAttr(loading.value) ? " disabled" : ""} class="btn btn-primary" type="submit" data-v-551b762f>`);
      if (!loading.value) {
        _push(`<span data-v-551b762f>\u041F\u043E\u0438\u0441\u043A</span>`);
      } else {
        _push(`<span data-v-551b762f>\u0418\u0434\u0451\u0442 \u043F\u043E\u0438\u0441\u043A...</span>`);
      }
      _push(`</button></div></div></form>`);
      if (error.value) {
        _push(`<div class="df-error" data-v-551b762f>${ssrInterpolate(error.value)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</section>`);
      if (searchResults.value && searchResults.value.length) {
        _push(`<section class="df-results" data-v-551b762f><div class="df-results-header" data-v-551b762f><div data-v-551b762f>\u0420\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u044B \u043F\u043E\u0434\u0431\u043E\u0440\u0430 \u0434\u043B\u044F \xAB<strong data-v-551b762f>${ssrInterpolate(lastKeyword.value)}</strong>\xBB \u2014 ${ssrInterpolate(searchResults.value.length)}</div></div><table class="df-table" data-v-551b762f><thead data-v-551b762f><tr data-v-551b762f><th data-v-551b762f>\u0414\u043E\u043C\u0435\u043D</th><th data-v-551b762f>\u0421\u0442\u0430\u0442\u0443\u0441</th><th data-v-551b762f>\u0426\u0435\u043D\u0430</th><th data-v-551b762f>\u0422LD</th><th data-v-551b762f></th></tr></thead><tbody data-v-551b762f><!--[-->`);
        ssrRenderList(searchResults.value, (item) => {
          var _a, _b;
          _push(`<tr data-v-551b762f><td class="td-domain" data-v-551b762f><div class="domain-name" data-v-551b762f>${ssrInterpolate(item.fqdn)}</div><div class="domain-sub" data-v-551b762f>${ssrInterpolate(((_b = (_a = item.attrs) == null ? void 0 : _a.raw) == null ? void 0 : _b.fqdn) || item.fqdn)}</div></td><td data-v-551b762f><span class="${ssrRenderClass(["badge", availabilityClass(item.available)])}" data-v-551b762f>${ssrInterpolate(availabilityText(item.available))}</span></td><td data-v-551b762f>`);
          if (!isAvailable(item.available)) {
            _push(`<div data-v-551b762f>-</div>`);
          } else if (item.price !== null && item.price !== void 0) {
            _push(`<div data-v-551b762f>${ssrInterpolate(formatPrice(item.price, item.price_currency))}</div>`);
          } else {
            _push(`<div class="muted" data-v-551b762f>\u2014</div>`);
          }
          _push(`</td><td data-v-551b762f>${ssrInterpolate(item.tld || extractTld(item.fqdn))}</td><td class="td-actions" data-v-551b762f><button class="btn small" data-v-551b762f>Whois</button><button class="btn primary small"${ssrIncludeBooleanAttr(!isAvailable(item.available)) ? " disabled" : ""} data-v-551b762f>\u0412\u044B\u0431\u0440\u0430\u0442\u044C</button></td></tr>`);
        });
        _push(`<!--]--></tbody></table></section>`);
      } else {
        _push(`<!--[-->`);
        if (!loading.value) {
          _push(`<section class="df-empty" data-v-551b762f><div class="empty-illustration" data-v-551b762f>\u{1F50E}</div><div class="empty-sub" data-v-551b762f>\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043A\u043B\u044E\u0447\u0435\u0432\u043E\u0435 \u0441\u043B\u043E\u0432\u043E \u0438 \u043D\u0430\u0436\u043C\u0438\u0442\u0435 \xAB\u041F\u043E\u0438\u0441\u043A\xBB, \u0447\u0442\u043E\u0431\u044B \u043F\u043E\u0434\u043E\u0431\u0440\u0430\u0442\u044C \u0434\u043E\u043C\u0435\u043D</div></section>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--]-->`);
      ...
      if (lastDeploy.value) {
        _push(`<section class="df-deploy-result" data-v-551b762f><h3 data-v-551b762f>\u0420\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442 \u0440\u0435\u0433\u0438\u0441\u0442\u0440\u0430\u0446\u0438\u0438/\u0434\u0435\u043F\u043B\u043E\u044F</h3><div class="deploy-grid" data-v-551b762f><div data-v-551b762f>\u0414\u043E\u043C\u0435\u043D: <strong data-v-551b762f>${ssrInterpolate(lastDeploy.value.domain)}</strong></div>`);
        if (lastDeploy.value.netlify_url) {
          _push(`<div data-v-551b762f>Netlify: <a${ssrRenderAttr("href", lastDeploy.value.netlify_url)} target="_blank" data-v-551b762f>\u043E\u0442\u043A\u0440\u044B\u0442\u044C \u0441\u0430\u0439\u0442</a></div>`);
        } else {
          _push(`<!---->`);
        }
        if (lastDeploy.value.admin_url) {
          _push(`<div data-v-551b762f>Admin: <a${ssrRenderAttr("href", lastDeploy.value.admin_url)} target="_blank" data-v-551b762f>\u0430\u0434\u043C\u0438\u043D\u043A\u0430</a></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div data-v-551b762f>DNS \u0441\u0442\u0430\u0442\u0443\u0441: <strong data-v-551b762f>${ssrInterpolate(lastDeploy.value.dns_status || "pending")}</strong></div></div></section>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</main></div>`);
...
const DomainFinder = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-551b762f"]]);

export { DomainFinder as D };
//# sourceMappingURL=domain-finder-C0TQ07P4.mjs.map
